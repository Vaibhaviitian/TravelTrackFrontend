...
export default function Home() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl">
      {ischeck ? (
        <>
          <div className="bg-gradient-to-r from-purple-500 to-indigo-500 text-black p-8 rounded-lg">
            <div className="grid gap-5 m-4 sm:grid-cols-2">
              <div>
            ...
            <div className="grid gap-5 m-4 sm:grid-cols-12">
              <div className="sm:col-span-4 text-center">
                <Link
                  class="text-black font-bold py-2 px-4 rounded hover:bg-gray-100 transition duration-300 mr-3"
                  to="/mytrips"
                >
                  Manage Your Trips
                </Link>
              </div>
              <div className="sm:col-span-8 h-10 text-center rounded hover:bg-gray-100 transition duration-300 mr-3">
                <Link
                  class="text-black font-bold py-2 mr-10 px-4 rounded  transition duration-300"
                  to="/createtrip"
                >
        ...
        <>
          <div class="bg-gradient-to-r from-blue-500 to-green-500 text-black p-8 rounded-lg shadow-lg flex items-center justify-between">
            <div className="grid gap-4 m-4 sm:grid-cols-2">
              <div>
                <h2 class="text-2xl font-bold mb-2">
                  Become a Verified Travel Agent
                </h2>
                <p class="text-lg mb-4" style={{ fontWeight: "bolder" }}>
                  Join our platform as a verified travel agent and gain
                  exclusive access to create and manage trips. Enjoy the
                  benefits of enhanced credibility and trust from travelers. Get
                  verified today and start earning with our paid agent program!!
                </p>
                <div>
                  {" "}
                  <NavLink
