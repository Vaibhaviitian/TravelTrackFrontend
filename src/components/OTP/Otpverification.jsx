    ...
    <div className="min-h-screen bg-gray-800 flex text-white items-center justify-center">
      <div className="w-max rounded-2xl bg-slate-900 shadow-lg">
        <div className="flex flex-col gap-2 p-5">
          ...
          <button className="inline-block mt-3 mb-3 cursor-pointer rounded-md bg-gray-700 px-4 py-3.5 text-center text-sm font-semibold uppercase text-white transition duration-200 ease-in-out hover:bg-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-700 focus-visible:ring-offset-2 active:scale-95" onClick={handleotp}>
            Register
          </button>
        </div>
      </div>
